				...
				<div class="container">
					<div class="row">				
						<dl class="services-list visible-xs visible-sm">
							<dt class="services-list-item-title">Междугороднее такси IntercityTAXI<a href="#" id="evaqKiev" class="complain-link"><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
								<a class="link-text" href="tel: +380933635250">(093) 363-52-50</a><br>
							</dd>
							<dt class="services-list-item-title">Метиор такси<a href="#" id="evaqKiev" class="complain-link" ><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
							...
							<dt class="services-list-item-title">Джем-такси<a href="#" id="evaqKiev" class="complain-link"><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
								<a class="link-text" href="tel: +380445028555">(044) 502-85-55</a><br>
								<a class="link-text" href="tel: +380445028555">(044) 502-85-55</a><br>
								<a class="link-text" href="tel: +380632717522">(063) 271-75-22</a><br>
							</dd>
							<dt class="services-list-item-title">Такси Окей<a href="#" id="evaqKiev" class="complain-link" ><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
								<a class="link-text" href="tel: +380443930303">(044) 393-03-03</a><br>
							</dd>
							<dt class="services-list-item-title">Радио Такси Столица<a href="#" id="evaqKiev" class="complain-link"><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
								<a class="link-text" href="tel: +380442496249">(044) 249-62-49</a><br>
								<a class="link-text" href="tel: +380933146249">(093) 314-62-49</a><br>
							</dd>
							<dt class="services-list-item-title">Такси 5<a href="#" id="evaqKiev" class="complain-link" ><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
							...
							<dt class="services-list-item-title">Лимузин такси<a href="#" id="evaqKiev" class="complain-link"><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
							...
							<dt class="services-list-item-title">Союз такси<a href="#" id="evaqKiev" class="complain-link"><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
								<a class="link-text" href="tel: +380444559555">(044) 455-95-55</a><br>
								<a class="link-text" href="tel: +380444559555">(044) 455-95-55</a><br>
								<a class="link-text" href="tel: +380993139555">(099) 313-95-55</a><br>
							</dd>
							<dt class="services-list-item-title">Такси на Дубровку<a href="#" id="evaqKiev" class="complain-link"  ><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
								<a class="link-text" href="tel: +380442908808">(044) 290-88-08</a><br>
							</dd>
							<dt class="services-list-item-title">Бизнес-такси<a href="#" id="evaqKiev" class="complain-link"><span class="glyphicon glyphicon-warning-sign"></span>Пожаловаться</a></dt>
							<dd class="services-list-item-text">
